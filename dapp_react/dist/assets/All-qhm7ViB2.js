import{p as n,l as C,r as N,G as I,n as G,u as P,j as t,q as R,s as T,aa as O,t as W,z as H,ab as q,ac as L,ad as J,ae as K,R as Q,v as V}from"./index-yFNPE8sD.js";import{C as D,B as m,N as M}from"./NftCard-XMlBsIGB.js";const X=({nft:e})=>{const{nftId:a,nftName:d,tokenUrl:s,nftPrice:r,collectionIpfs:p,fileName:u,ext:b}=e,v=p&&s!==p?`${s}/${u}`:s,j=C(v),{description:l,image:o,attributes:h}=j,{setMyNfts:w,account:x,myNfts:$,signer:g}=N.useContext(I),{handleWithLoading:y}=G(),f=N.useRef(null),S=()=>{const i=$.map(c=>c.nftId===a?{...c,nftPrice:Number(f.current.value),owner:x}:c);w(i)},E=async()=>{await y(()=>_(),"판매 등록 중입니다")&&(S(),f.current.value="",H("판매 등록이 완료되었습니다."))},U=()=>{var i;return(i=f.current)!=null&&i.value?!0:(Q.fire("가격을 입력해주세요"),!1)},_=async()=>{var i;if(U())try{const c=Number((i=f.current)==null?void 0:i.value);if(!(await q(g,a)).status||!(await L(g,a,c)).status)return;const F=await J(s);return!!(await K(a,F,c)).ok}catch(c){return console.error("Error setting onsale:",c),!1}},k=P(),A=()=>{k(p?`/nft-detail/collection/${s}/${a}`:`/nft-detail/${s}/${a}`)},B=(l==null?void 0:l.length)>15?(l==null?void 0:l.slice(0,15))+"...":l;return t.jsxs(D,{children:[t.jsx(Z,{onClick:A,children:o?t.jsx(m,{src:`${R(o,b)}?w=200&h=200`,onError:i=>i.currentTarget.src=T(o),alt:"NFT image"}):t.jsx(m,{src:O,alt:"loading..."})}),t.jsxs(Y,{children:[t.jsx(M,{onClick:()=>W(d),children:d}),t.jsx("div",{style:{marginTop:"5px"},children:B})]}),t.jsxs(rt,{children:[t.jsx(tt,{type:"number",ref:f,placeholder:"단위: ETH"}),t.jsx(et,{onClick:E,children:"판매 등록"})]})]})},Y=n.div`
...
`;const it=n.div`
  ...
  justify-content: center;
  margin-top: 5px;
`,lt=()=>{const{myNfts:e,account:a}=N.useContext(I),d=e.filter(r=>r.nftPrice),s=e.filter(r=>!r.nftPrice);return t.jsxs(ct,{children:[e.length>0&&t.jsxs(z,{children:[d.map(r=>t.jsx(at,{nft:r,account:a},`mypage-all-onsale-${r.nftId}-${r.nftName}`)),s.map(r=>t.jsx(X,{nft:r,account:a},`mypage-all-nonsale-${r.nftId}-${r.nftName}`))]}),e.length<1&&t.jsx("h2",{children:"No NFTs"})]})},ct=n.div`
  display: flex;
  justify-content: center;
`,z=n.ul`
  display: inline-grid;
...
`,ht=Object.freeze(Object.defineProperty({__proto__:null,MyNftsWrap:z,default:lt},Symbol.toStringTag,{value:"Module"}));export{ht as A,z as M,X as N,at as O};
